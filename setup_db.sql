-- CSC SAT 2026 Database Setup
-- Run this in MySQL: source setup_db.sql;

CREATE DATABASE IF NOT EXISTS sat2026_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE sat2026_db;
